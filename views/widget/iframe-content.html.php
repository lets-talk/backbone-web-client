    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            window.chatConfig = {
                ...
                newMessagesPath        : '/conversations?auth_token=%s&sync_time=%s&client_id=%s&filter_empty_conversations=true&organzation_id=%s',
                markMessagesReadPath   : '<?php echo $app->path("Message:markMessagesRead") ?>',
                lastMessagesPath       : '<?php echo $app->path("Message:getLast") ?>',
                sendMessagePath        : '/conversations/%d/messages?auth_token=%s',
